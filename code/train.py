...
parser.add_argument("--use-domain-emb", dest="use_domain_emb", type=int, metavar='<int>', default=0, help="whether to use domain-specific embeddings")
...
if args.domain == "norec_fine":
    if args.use_domain_emb:
        assert args.emb_dim == 200
    else:
        assert args.emb_dim == 100
else:
    if args.use_domain_emb:
